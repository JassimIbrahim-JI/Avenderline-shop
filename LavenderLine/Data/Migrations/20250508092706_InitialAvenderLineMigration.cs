...
{
    /// <inheritdoc />
    public partial class InitialAvenderLineMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActiveHome = table.Column<bool>(type: "boolean", nullable: false),
                    IsActiveShop = table.Column<bool>(type: "boolean", nullable: false),
                    IsActiveArrivals = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscribedOn = table.Column<Instant>(type: "timestamp without time zone", nullable: false),
                    UnsubscribedOn = table.Column<Instant>(type: "timestamp without time zone", nullable: true),
                    UnsubscribeToken = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    TokenExpiration = table.Column<Instant>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<string>(type: "text", nullable: true),
                    OrderDate = table.Column<Instant>(type: "timestamp without time zone", nullable: false),
                    DeliveryDate = table.Column<Instant>(type: "timestamp without time zone", nullable: true),
                    TotalAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    PaymentId = table.Column<long>(type: "bigint", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ModifiedDate = table.Column<Instant>(type: "timestamp without time zone", nullable: true),
                    GuestFullName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    GuestAddress = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    ShippingFee = table.Column<decimal>(type: "numeric(5,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "text", nullable: true),
                    CreatedDate = table.Column<Instant>(type: "timestamp without time zone", nullable: false),
                    UpdatedDate = table.Column<Instant>(type: "timestamp without time zone", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    IsFeatured = table.Column<bool>(type: "boolean", nullable: false),
                    IsExcludedFromRelated = table.Column<bool>(type: "boolean", nullable: false),
                    Lengths = table.Column<string[]>(type: "text[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangeDate = table.Column<Instant>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentDate = table.Column<Instant>(type: "timestamp without time zone", nullable: false),
                    PaymentMethod = table.Column<string>(type: "text", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    PaymentIntentId = table.Column<string>(type: "text", nullable: false),
                    RefundDate = table.Column<Instant>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountPercentage = table.Column<decimal>(type: "numeric(18,0)", nullable: false),
                    StartDate = table.Column<Instant>(type: "timestamp without time zone", nullable: false),
                    EndDate = table.Column<Instant>(type: "timestamp without time zone", nullable: false),
                    ProductId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    AddedDate = table.Column<Instant>(type: "timestamp without time zone", nullable: true)
                },
                constraints: table =>
                {
